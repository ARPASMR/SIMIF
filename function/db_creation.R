...
comuni_db <- dbConnect(RSQLite::SQLite(), dbname = "db/comuni_db") #creo db di nome comuni_db
...
ncfile_surf <- nc_open("nc/sorted_surf_C5M.nc")
...
meteo_db_5m <- dbConnect(RSQLite::SQLite(),dbname = "db/meteo_db_5m")
